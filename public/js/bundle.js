...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY3VyYXRvcjY5IiwiYSI6ImNrejA2NGwzZTAyZjYyd3BuNzIyZzA3ZzAifQ.foqIs3Sq5H6QJGCAi9tXdg';
...
var stripe = Stripe('pk_test_51KQH5ZSEgZPuDtVmvvnJItYc4XsgLbrb87ZapMnoJYz9vzlUNDle4QIdjf8zFpxPUKYPIeBv0zhtnsBemkVfULu900wF7o0BvE');
...
var loginForm = document.querySelector('.form--login-btn');
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  form.append(document.getElementById('name').value);
  form.append(document.getElementById('email').value);
  form.append(document.getElementById('photo').files[0]);
